...
def calendar_month(request):
    ...
    # Build a list of weeks for the selected month (each week is a list of 7 day numbers)
...
def meeting_detail(request, pk):
    ...
    # Get the meeting by its primary key, or return a 404 if it does not exist
...
# ── CREATE MEETING VIEW ────────────────────────────────────────────────────────
# Displays and handles the create meeting form
...
def calendar_day(request):
    ...
    # Calculate the pixel position and height for each meeting block on the grid
...
# ── EDIT MEETING VIEW ──────────────────────────────────────────────────────────
# Displays and handles the edit meeting form for an existing meeting
